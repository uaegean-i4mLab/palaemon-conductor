...
@Configurable
public class GetPassengerDetailsTask implements Worker {

    /**
     * The logger.
     */
    private final Logger logger =
            LoggerFactory.getLogger(GetPassengerDetailsTask.class);
     ...
     */
    public GetPassengerDetailsTask(String taskDefName, DBProxyService dbProxyService) {
...
//        });
        ...
        logger.info("Input: ");
        logger.info("Output: ");
        logger.info("Number of Passengers: {}", personList.size());
        logger.info("-----\n");
        //Register the output of the task
        result.getOutputData().put("passenger_details",personList);
